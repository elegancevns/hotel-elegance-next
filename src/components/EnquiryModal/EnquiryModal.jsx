        ...
        try {
            ...
            if (response.ok && result.status === true) {
                ...
                if (result.errors) {
                    ...
                    setSubmitStatus('error');
                    setServerError(result.message || 'Failed to submit enquiry. Please try again.');
                }
            }
    ...
    return (
        <div className="fixed inset-0 z-50 overflow-y-auto">
            ...
            <div className="flex min-h-full items-center justify-center p-4">
                <div className="relative bg-gradient-to-tr from-[#410f06] via-[#410f06] to-[#aa833f] backdrop-blur-sm rounded-2xl p-3 md:p-3 w-full max-w-2xl mx-auto border border-gray-700/50">
                    <button
                        onClick={onClose}
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            {title && (
                                <div className="d-none">
                                    ...
                                    <input
                                        ...
                                        className={`w-full px-4 py-3 bg-white/10 border rounded-lg text-white placeholder-white-400 focus:outline-none focus:ring-2 focus:ring-white/30 transition-all text-sm ${errors.title
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        value={formData.name}
                                        onChange={handleChange}
                                        className={`w-full px-4 py-3 bg-white/10 border rounded-lg text-white placeholder-white  focus:outline-none focus:ring-2 focus:ring-white/30 transition-all text-sm ${errors.name
                                            ? 'border-red-500 focus:border-red-500'
                                            : 'border-white/20 focus:border-transparent'
                                            }`}
                                        disabled={isSubmitting}
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className={`w-full px-4 py-3 bg-white/10 border rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-white/30 transition-all text-sm ${errors.email
                                            ? 'border-red-500 focus:border-red-500'
                                            : 'border-white/20 focus:border-transparent'
                                            }`}
                                        disabled={isSubmitting}
                            ...
                            <div className="pt-4">
                                <button
                                    type="submit"
                                    disabled={isSubmitting}
                                    className={`w-full px-3 py-3 rounded bg-white text-[#410f06] font-semibold rounded-lg transition-all duration-300 flex items-center justify-center ${isSubmitting
